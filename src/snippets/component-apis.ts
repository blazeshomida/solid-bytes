...
export const componentApis: Record<string, Snippet> = {
  ...
  context: {
    ...
    body: `
    export const $2Context = createContext$1($3)
    export function use$2Context() {
      const context = useContext$1($2Context)
      if (!context) {
        throw new Error("use$2Context: cannot find a $2Context")
      }
      return context
    }
